...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'bicing_stats.adapter.storage.txt_file' => 'getBicingStats_Adapter_Storage_TxtFileService',
            'bicing_stats.bicing_api' => 'getBicingStats_BicingApiService',
            'bicing_stats.domain.repository.station' => 'getBicingStats_Domain_Repository_StationService',
            'buzz' => 'getBuzzService',
            'cache_clearer' => 'getCacheClearerService',
            'cache_warmer' => 'getCacheWarmerService',
            'command_handler.save_api_snapshot_to_db' => 'getCommandHandler_SaveApiSnapshotToDbService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Users/alex/personal/bicing-stats/app/cache/dev/annotations', true);
    }
    ...
    /**
     * Gets the 'bicing_stats.adapter.storage.txt_file' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \BicingStats\Adapter\Storage\FileStorage A BicingStats\Adapter\Storage\FileStorage instance.
     */
    protected function getBicingStats_Adapter_Storage_TxtFileService()
    {
        return $this->services['bicing_stats.adapter.storage.txt_file'] = new \BicingStats\Adapter\Storage\FileStorage();
    }

    /**
     * Gets the 'bicing_stats.bicing_api' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \BicingStats\Adapter\BicingApi A BicingStats\Adapter\BicingApi instance.
     */
    protected function getBicingStats_BicingApiService()
    {
        return $this->services['bicing_stats.bicing_api'] = new \BicingStats\Adapter\BicingApi($this->get('buzz'));
    }

    /**
     * Gets the 'bicing_stats.domain.repository.station' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \BicingStats\Domain\Repository\StationRepository A BicingStats\Domain\Repository\StationRepository instance.
     */
    protected function getBicingStats_Domain_Repository_StationService()
    {
        return $this->services['bicing_stats.domain.repository.station'] = new \BicingStats\Domain\Repository\StationRepository($this->get('bicing_stats.adapter.storage.txt_file'));
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/Users/alex/personal/bicing-stats/app/Resources');

        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, $this->get('templating.locator')), 1 => new \Symfony\Bundle\AsseticBundle\CacheWarmer\AssetManagerCacheWarmer($this), 2 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 3 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c), 4 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine'))));
    }

    /**
     * Gets the 'command_handler.save_api_snapshot_to_db' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \BicingStats\Application\Command\SaveApiSnapshotToDbCommandHandler A BicingStats\Application\Command\SaveApiSnapshotToDbCommandHandler instance.
     */
    protected function getCommandHandler_SaveApiSnapshotToDbService()
    {
        return $this->services['command_handler.save_api_snapshot_to_db'] = new \BicingStats\Application\Command\SaveApiSnapshotToDbCommandHandler($this->get('bicing_stats.bicing_api'), $this->get('bicing_stats.domain.repository.station'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'bicing_stats', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_ef29d29c09819a93b32f787718065512f612df0161e3c31ec4b1ebccb917ed3d');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_ef29d29c09819a93b32f787718065512f612df0161e3c31ec4b1ebccb917ed3d');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_ef29d29c09819a93b32f787718065512f612df0161e3c31ec4b1ebccb917ed3d');

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array('/Users/alex/personal/bicing-stats/src/BicingStats/Bundle/MainBundle/Resources/config/doctrine' => 'BicingStats\\Domain\\Model\\Station'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver($d, 'BicingStats\\Domain\\Model\\Station');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('StationMapping' => 'BicingStats\\Domain\\Model\\Station'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        $f->setProxyDir('/Users/alex/personal/bicing-stats/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Users/alex/personal/bicing-stats/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Users/alex/personal/bicing-stats/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Users/alex/personal/bicing-stats/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/Users/alex/personal/bicing-stats/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/Users/alex/personal/bicing-stats/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Users/alex/personal/bicing-stats/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/Users/alex/personal/bicing-stats/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Users/alex/personal/bicing-stats/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Users/alex/personal/bicing-stats/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/Users/alex/personal/bicing-stats/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/Users/alex/personal/bicing-stats/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/Users/alex/personal/bicing-stats/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Users/alex/personal/bicing-stats/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/Users/alex/personal/bicing-stats/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/Users/alex/personal/bicing-stats/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/Users/alex/personal/bicing-stats/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/Users/alex/personal/bicing-stats/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/Users/alex/personal/bicing-stats/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/Users/alex/personal/bicing-stats/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/Users/alex/personal/bicing-stats/app/Resources/views');
        $instance->addPath('/Users/alex/personal/bicing-stats/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/Users/alex/personal/bicing-stats/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Users/alex/personal/bicing-stats/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Users/alex/personal/bicing-stats/app/cache/dev/assetic/assets');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5420b97a848dd')), true);
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Users/alex/personal/bicing-stats/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Users/alex/personal/bicing-stats/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Users/alex/personal/bicing-stats/app/cache/dev',
            'kernel.logs_dir' => '/Users/alex/personal/bicing-stats/app/logs',
            'kernel.bundles' => array(
                ...
                'BicingStatsMainBundle' => 'BicingStats\\Bundle\\MainBundle\\BicingStatsMainBundle',
            ...
            'debug.container.dump' => '/Users/alex/personal/bicing-stats/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/Users/alex/personal/bicing-stats/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/Users/alex/personal/bicing-stats/app/cache/dev/profiler',
            ...
            'router.resource' => '/Users/alex/personal/bicing-stats/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Users/alex/personal/bicing-stats/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/Users/alex/personal/bicing-stats/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Users/alex/personal/bicing-stats/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/Users/alex/personal/bicing-stats/app/../web',
            'assetic.write_to' => '/Users/alex/personal/bicing-stats/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/Users/alex/personal/bicing-stats/app/cache/dev/doctrine/orm/Proxies',
